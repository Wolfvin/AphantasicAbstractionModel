...
compositional sense definitions, and autonomous tiered memory lifecycle.
...
# Single source of truth for versioning — all other modules read from here.
from ._version import __version__, __schema_version__, __api_version__
