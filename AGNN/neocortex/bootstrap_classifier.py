...
DEFAULT_CORPUS_PATHS: List[str] = [
    ...
    os.path.join(_DATA_DIR, "pretrain_corpus_bahwa.txt"),
    os.path.join(_DATA_DIR, "pretrain_corpus_di_prefix.txt"),
    os.path.join(_DATA_DIR, "pretrain_corpus_me_nonnasal.txt"),
]
